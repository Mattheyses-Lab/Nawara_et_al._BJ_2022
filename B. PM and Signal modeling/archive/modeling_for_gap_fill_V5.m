function modeling_for_gap_fill_V5(n_cell, PSF_infocus)
...
while generate_sim == 1
    ...
    spread_diffraction_signal = conv2(spread_diffraction_signal, PSF_infocus, 'same'); %PSF modeled
    ...
    spread_bigger_signal = conv2(spread_bigger_signal, PSF_infocus, 'same'); %PSF modeled
