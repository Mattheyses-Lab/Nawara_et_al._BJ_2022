function modeling_for_gap_fill_V3(n_cell)
close all;
...
while generate_sim == 1
    ...
    for nn = 1:3
        for radius = (1+nn):(4+nn)
            ...
            bigger_signal_pic = signal_only_mask_bigger_structres * (bigger_signal(nn)/(radius/2)); %figure; imagesc(bigger_signal_pic)
    ...
    back_plus_signal = back_plus_signal .* Z;
...
cell_mat2tiff(['C:\Users\tnawara\Desktop\Test of gap filing\Fake cells\Pseudo_PM_488.00', num2str(n_cell), '.tif'], pseudo_PM_noisy)
